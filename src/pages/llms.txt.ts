...
export const GET: APIRoute = ({ site }) => {
  ...
  const content = [
    ...
    '',
    '## About This Site',
    `This is a luxury real estate property landing page. It presents property information, media showcase, pricing, amenities, and a contact form for prospective buyers and investors.`,
    isSectionEnabled('contact-form') ? `\n## Contact\n- Submit an enquiry via the contact form at ${siteUrl}/#contact-form` : null,
